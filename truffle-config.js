...
const provider = new HDWalletProvider({
  ...
  pollingInterval: 60000, // Set the polling interval to 60 seconds (60000 milliseconds)
});
...
module.exports = {
  ...
  networks: {
    ...
    sepolia: {
      ...
      timeoutBlocks: 1000, // Increase number of blocks before deployment times out
